...
public class FirstPersonController : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        OSCHandler.Instance.SendMessageToClient("pd", "/unity/california", 1);
        OSCHandler.Instance.SendMessageToClient("pd", "/unity/soda", "ready");
        OSCHandler.Instance.SendMessageToClient("pd", "/unity/sun", "ready");
        OSCHandler.Instance.SendMessageToClient("pd", "/unity/tree", "ready");
        OSCHandler.Instance.SendMessageToClient("pd", "/unity/jump", "ready");
    ...
    void FixedUpdate()
    {
        ...
        if (playerCanMove)
        {
            ...
            if (targetVelocity.x != 0 || targetVelocity.z != 0 && isGrounded)
            {
                ...
                OSCHandler.Instance.SendMessageToClient("pd", "/unity/walkvolume", 5);
    ...
    void OnTriggerEnter(Collider other)
    {
        if (other.gameObject.CompareTag("ball"))
        {
           ...
           if (count==3)
            {
                OSCHandler.Instance.SendMessageToClient("pd", "/unity/soda", 3);
            }
            if (count == 5)
            {
                OSCHandler.Instance.SendMessageToClient("pd", "/unity/sun", 2);
            }
